...
import net.dummythinking.difficultLife.item.GlassArmor;
import net.dummythinking.difficultLife.item.HeartContainer;
...
import static net.dummythinking.difficultLife.init.DLConfigSetup.*;
